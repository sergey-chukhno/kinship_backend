...
RSpec.describe "CompanyAdminPanel::CompanyMembers", type: :request do
  ...
  describe "GET /show" do
    context "when user is not logged in" do
      it "redirects to login page" do
        get company_admin_panel_company_member_path(company_confirmed, status: :pending)
        expect(response).to redirect_to(new_user_session_path)

        get company_admin_panel_company_member_path(company_pending, status: :pending)
        expect(response).to redirect_to(new_user_session_path)
      end
    end
