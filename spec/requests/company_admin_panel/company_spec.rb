...
RSpec.describe "CompanyAdminPanel::Companies", type: :request do
  ...
  describe "GET /edit" do
    context "when user is not logged in" do
      it "redirects to login page" do
        get edit_company_admin_panel_company_path(company_confirmed)
        expect(response).to redirect_to(new_user_session_path)

        get edit_company_admin_panel_company_path(company_pending)
        expect(response).to redirect_to(new_user_session_path)
      end
    end
