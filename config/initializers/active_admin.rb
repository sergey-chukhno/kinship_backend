...
ActiveAdmin.setup do |config|
  config.footer = "Powered by Drakkar"
  ...
  config.namespace :admin do |admin|
    admin.build_menu do |menu|
      menu.add label: "Gestions des projets", priority: 1
      menu.add label: "Gestion des établissements", priority: 2
      menu.add label: "Gestion des associations", priority: 3
    end
  end
  #
  ...
  config.prepend_before_action -> { Time.zone = "Paris" }
