...
class Api::V1::Schools::BranchRequestsController < Api::V1::Schools::BaseController
  ...
  # GET /api/v1/schools/:school_id/branch_requests
  ...
  # POST /api/v1/schools/:school_id/branch_requests
  ...
  # PATCH /api/v1/schools/:school_id/branch_requests/:id/confirm
  ...
  # PATCH /api/v1/schools/:school_id/branch_requests/:id/reject
  ...
  # DELETE /api/v1/schools/:school_id/branch_requests/:id
